...
import { createNewContour } from '../components/topography.js';
...
const routes = [
	...
	{ path: '/senorcode', view: view.senor },
...
const buildActivePage = async function (activePage) {
	...
	const contour = user.deviceIsMobile
		? new TopoContour(
				view.location.geo,
				view.location.page,
				view.svgExportMobile,
				view.svgOptionsMobile
		  )
		: new TopoContour(
				view.location.geo,
				view.location.page,
